...
- Top bar (white, thin bottom border): "Suraksha control room · East Khasi Hills", a small green dot with "Live", the current officer "Insp. R. Lyngdoh" on the right, and buttons "Send notice to tourists" and "Add risk zone".
